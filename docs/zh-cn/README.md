...
9. [Shared Skill 使用协议](/home/work/code/agentdevpipeline/docs/zh-cn/reference/skill-protocol.md)
10. 平台接入文档
11. `prompts/zh-cn/` 中的 Issue / 变更 / 异常 / 合规机制
12. `skills/shared/` 中的角色、workflow、template
