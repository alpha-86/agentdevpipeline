...
**Project ID**: ADP-BOOTSTRAP-001
**主 Issue**: #0
**当前 Gate**: Governance
**更新日期**: 2026-04-09

| 产物 | 链接 | 状态 | 对应 Comment | Owner | 备注 |
|---|---|---|---|---|---|
| Issue | `#0` | Active | N/A | Team Lead | 示例主索引 |
| PRD | `docs/prd/000_example_user_notification_center_2026-04-09.md` | Draft Example | N/A | Product Manager | 示例文档 |
