...
6. 文档阶段需要 Human Review #1 的项目，在 Human Review #1 完成前不得进入 实现阶段。
...
1. 读取主 issue 和最新 PRD。
2. 检查最近一次 PRD 评审、Human Review 和 change record。
